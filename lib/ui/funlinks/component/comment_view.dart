import 'package:famelink/ui/funlinks/component/reply_view.dart';
import 'package:famelink/ui/funlinks/component/report_dialogs.dart';
                                              ...
                                              provider.getCommentReplies(context, comment.sId!).then((value) {
                                                showModalBottomSheet(
                                                    ...
                                                    builder: (BuildContext context) {
                                                      return RepliesViewFunLinks(postId: widget.postId, userId: widget.userId, newUserId: widget.newUserId, type: widget.type, index: index, comment: comment);
                                                    });
                                              });
                                            }),
                                        flex: 2,
