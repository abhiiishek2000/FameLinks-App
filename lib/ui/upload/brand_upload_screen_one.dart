...
import 'package:famelink/ui/upload/brand_upload_screen_two.dart';
...
class BrandUploadScreenOne extends StatefulWidget {
  ChallengesModelData? challengesModelData;

  BrandUploadScreenOne({this.challengesModelData});

  @override
  _BrandUploadScreenOneState createState() => _BrandUploadScreenOneState();
}

class _BrandUploadScreenOneState extends State<BrandUploadScreenOne> {
                    ...
                    children: [
                      InkWell(
                          onTap: () {
                            _cropImage(mainImageList[pageController.initialPage]
                                ...
                                .then((value) async {
                              print(value!.path);
                              int pos = imageList[pageController.initialPage]
                                  .position;
                              if (pos == 0) {
                                closeUpImageFile = value as File;
                                Constants.closeUp =
                                ...
                                poseOneImageFile = value as File;
                                ...
                                poseTwoImageFile = value as File;
                                ...
                                additionalImageFile = value as File;
                                Constants.additional =
                                await MultipartFile.fromFile(value.path,
                                    filename:
                                    "${value.path
                      ...
                      InkWell(
                          onTap: () async {
                            ...
                            croppedImages.add(
                                imageList[pageController.initialPage].file);
                        ...
                        if (closeUpImageFile != null ||
                          ...
                          if (screenTwoData.length > 0) {
                            final result = await Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        BrandUploadScreenTwo(

                                            screenTwoData: screenTwoData,
                                        challengesModelData:widget.challengesModelData!)));
                            if (result != null) {
                          ...
                          onPressed: () async {
                            ...
                            if (screenTwoData.length > 0) {
                              final result = await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => BrandUploadScreenTwo(
                                          screenTwoData: screenTwoData)));
                      ...
                      try {
                        ...
                        _cropImage(mainCropImageFile).then((value) async {
                          ...
                          setState(() {
                            ...
                            imageList.add(FileModel(0, value as File));
                          });
                      ...
                      try {
                        ...
                        _cropImage(mainCropImageFile).then((value) async {
                          ...
                          setState(() {
                            ...
                            imageList.add(FileModel(1, value as File));
                          });
                          Constants.medium = await MultipartFile.fromFile(
                              value.path,
                              filename:
                      ...
                      try {
                        ...
                        _cropImage(mainCropImageFile).then((value) async {
                          ...
                          setState(() {
                            ...
                            imageList.add(FileModel(2, value as File));
                          });
                          Constants.long = await MultipartFile.fromFile(
                              value.path,
                              filename:
                      ...
                      try {
                        ...
                        _cropImage(mainCropImageFile).then((value) async {
                          ...
                          setState(() {
                            ...
                            imageList.add(FileModel(3, value as File));
                          });
                          Constants.pose1 = await MultipartFile.fromFile(
                              value.path,
                              filename:
                      ...
                      try {
                        ...
                        _cropImage(mainCropImageFile).then((value) async {
                          ...
                          setState(() {
                            ...
                            imageList.add(FileModel(4, value as File));
                          });
                          Constants.pose2 = await MultipartFile.fromFile(
                              value.path,
                              filename:
                      ...
                      try {
                        ...
                        _cropImage(mainCropImageFile).then((value) async {
                          ...
                          setState(() {
                            ...
                            imageList.add(FileModel(5, value as File));
                          });
