...
class OtherUserProfileFunLinksModel {
  List<OtherUserProfileFunLinksModelResult>? result;
  String? message;
  bool? success;

  OtherUserProfileFunLinksModel({this.result, this.message, this.success});

  OtherUserProfileFunLinksModel.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <OtherUserProfileFunLinksModelResult>[];
      json['result'].forEach((v) {
        result!.add(new OtherUserProfileFunLinksModelResult.fromJson(v));
      });
    }
...
class OtherUserProfileFunLinksModelResult {
  String? sId;
  String? name;
  String? profession;
  ...
  OtherUserProfileFunLinksModelResult(
      {this.sId,
        this.name,
        this.profession,
        this.restrictedList,
  ...
  OtherUserProfileFunLinksModelResult.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    name = json['name'];
