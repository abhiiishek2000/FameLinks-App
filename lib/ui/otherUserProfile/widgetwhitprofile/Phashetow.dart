...
class Phashetowwhitemode extends StatelessWidget {
  Phashetowwhitemode({Key? key, this.id, this.isshow}) : super(key: key);
  String? id;
  String? isshow;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<OtherPofileprovider, FunLinksFeedProvider>(
      builder: (context, otherPofileprovider, funLinksProvider, child) {
        // print(
        //     "Jay mata di fun ${otherPofileprovider.userPostsfun!.length}");
                                                          ...
                                                          builder: (context) => ChattingScreen(
                                                              otherPofileprovider!
                                                                  .otherUserProfileFunLinksModel[
                                                                      0]
                                                                  .name!,
                                                              "${otherPofileprovider!.otherUserProfileFunLinksModel[0].profileImage}",
                                                              otherPofileprovider!
                                                                  .otherUserProfileFunLinksModel[
                                                                      0]
                                                                  .masterUser!
                ...
                ? SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: otherPofileprovider!
                            .otherUserProfileFunLinksModel[0].posts!.length,
                        physics: NeverScrollableScrollPhysics(),
                        shrinkWrap: true,
