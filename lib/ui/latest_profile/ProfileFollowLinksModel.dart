...
class ProfileFollowLinksModel {
  List<ProfileFollowLinksModelResult>? result;
  String? message;
  bool? success;

  ProfileFollowLinksModel({this.result, this.message, this.success});

  ProfileFollowLinksModel.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <ProfileFollowLinksModelResult>[];
      json['result'].forEach((v) {
        result?.add(new ProfileFollowLinksModelResult.fromJson(v));
      });
    }
...
class ProfileFollowLinksModelResult {
  String? sId;
  String? name;
  String? bio;
  String? profession;
  ...
  ProfileFollowLinksModelResult.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    name = json['name'];
    bio = json['bio'];
