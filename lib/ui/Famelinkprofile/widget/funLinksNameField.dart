...
class funLinksNameField extends StatelessWidget {
  const funLinksNameField({Key? key}) : super(key: key);
              ...
              Row(
                ...
                children: <Widget>[
                  Row(children: [
                    ...
                    fameLinkFun.profileFunLinksList.length != 0
                        ? fameLinkFun.profileFunLinksList[0].profileImageType ==
                                ""
                    ...
                    fameLinkFun.profileFunLinksList.isNotEmpty &&
                            fameLinkFun.profileFunLinksList[0].name != null &&
                  ...
                  DarkEditButton(
                      onPressed: () {
                        ...
                        String tempDate = fameLinkFun
                                    .profileFunLinksList[0].masterUser!.dob !=
                                'null'
                        ...
                        gotoUserEditProfileScreen(
                          ...
                          countrys: fameLinkFun
                              .profileFunLinksList[0].masterUser!.country
                              .toString(),
                          districts: fameLinkFun
                              .profileFunLinksList[0].masterUser!.district
                              .toString(),
                          states: fameLinkFun
                              .profileFunLinksList[0].masterUser!.state
                              .toString(),
                          bios:
                              fameLinkFun.profileFunLinksList[0].bio.toString(),
                          imagUrls: fameLinkFun
                              .profileFunLinksList[0].profileImage
                              .toString(),
                          imageType: fameLinkFun
                              .profileFunLinksList[0].profileImageType,
                          names: fameLinkFun.profileFunLinksList[0].name
                              .toString(),
                          professions: fameLinkFun
                              .profileFunLinksList[0].profession
                              .toString(),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      onTap: () {
                        if (fameLinkFun
                                .profileFunLinksList[0].masterUser!.fameCoins !=
                            null) {
