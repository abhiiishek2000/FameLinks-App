...
class FamelinkwidgetTop extends StatelessWidget {
  const FamelinkwidgetTop({Key? key}) : super(key: key);
                        ...
                        Row(
                          children: [
                            Text(
                              ...
                              //     : "",
                              Constants.userType == 'brand'
                                  ? provider.store[0].urlVisits.toString() ?? ""
                                ...
                                Text(
                                  Constants.userType == 'brand'
                                      ? provider.store.isNotEmpty
                                          ? provider
                                              .store[0].trendzsSponsored!.length
                                              .toString()
                                          : ""
                                      : provider.profileFameLinksModelResult
                                              .result!.isNotEmpty
                      ...
                      : Column(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              ...
                              child: userProfileData.getTitleWonClicked == true
                                  ? Icon(
                                      Icons.keyboard_arrow_up,
                                      color: Colors.white.withOpacity(0.25),
                                    )
