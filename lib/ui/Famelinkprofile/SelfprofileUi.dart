...
import 'package:famelink/ui/Famelinkprofile/widget/SelfProfileDiler.dart';
import 'package:famelink/ui/Famelinkprofile/widget/followLinksWidgetTop.dart';
...
class SelfprofileUi extends StatelessWidget {
  SelfprofileUi(
      {Key? key,
                ...
                children: <Widget>[
                  ...
                  provider.profileFunLinksList.length != 0 &&
                      ...
                      ? ListView.separated(
                          ...
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemCount: provider.profileFunLinksList[0].savedMusic!.length,
                          itemBuilder: (BuildContext context, int index) {
                            return Padding(
                              padding: const EdgeInsets.only(left: 20),
                              child: Row(
                  ...
                  provider.profileFollowLinksList.length != 0 && provider.requestClicked == true
                      ? ListView.separated(
                          separatorBuilder: (context, index) => Divider(
                            color: Colors.grey,
                          ),
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemCount: provider.profileFollowLinksList[0].requests!.length,
                          itemBuilder: (BuildContext context, int index) {
                  ...
                  Align(
                    ...
                    child: Visibility(
                      ...
                      //                     children: [
                      //                       Text(
                      //                           provider.upperProfileData !=
                      //                                   null
                      //                               ? "${provider.upperProfileData!.profession != null ? '${provider.upperProfileData!.profession}' : ''}"
                      //                               : "",
                      //                           style: GoogleFonts.nunitoSans(
                      //                               fontSize:
                      //                                   ScreenUtil().setSp(14),
                  ...
                  Visibility(
                    ...
                    child: provider.profileFunLinksList.length != 0
                        ? Padding(
                            padding: const EdgeInsets.only(
                                left: 15, right: 15, bottom: 15),
                            child: provider.profileFunLinksList[0].bio == null ||
                                ...
                                : Provider.of<UserProfileProvider>(context,
                                    ...
                                    : Align(
                                        alignment: Alignment.topLeft,
                                        child: ReadMoreText(
                                          provider.profileFunLinksList[0].profession !=
                                                      null &&
                  ...
                  Visibility(
                    ...
                    child: provider.profileFollowLinksList.length != 0
                        ? Padding(
                            padding: const EdgeInsets.only(
                                left: 15, right: 15, bottom: 15),
                            child: provider.profileFollowLinksList[0].bio == null ||
                  ...
                  Visibility(
                    visible: provider.selectPhase == 1 && provider.selectPhase == 2,
                    child: Padding(
                      padding: const EdgeInsets.only(
                        left: 20.0,
                        bottom: 8.0,
                                ...
                                provider.myFameResult.isNotEmpty
                                    ? GridView.count(
                                        ...
                                        children: List.generate(
                                            provider.myFameResult.length, (index) {
                                            ...
                                            onTap: () async {
                                              ...
                                              if (result != null) {
                                                ...
                                                Api.put.call(context,
                                                  ...
                                                  provider.getStoreLinkProfile(context);
                                                });
                                              }
                                            },
                                            child: Container(
                                              ...
                                              child: Stack(
                                                children: [
                                                  SizedBox(
                                                    child: provider.myFameResult[index]
                                                                    .images !=
                                                                null &&
                                                            provider.myFameResult[index]
                                                                    .images!
                                                                    .length >
                                                                0
                                                        ? provider.myFameResult[index]
                                ...
                                provider.followLinkData.isNotEmpty
                                    ? GridView.count(
                                        ...
                                        padding: EdgeInsets.only(
                                            ...
                                            right: ScreenUtil().setSp(2.5)),
                                        children: List.generate(
                                            provider.followLinkData.length, (index) {
                                          // if(provider.myFameResult[index].images[0].type == "video"){
                                          //   print("VIDEO:::${provider.myFameResult[index].images[0].type}");
                                          //   downloadFile(provider.myFameResult[index].images[0].path);
                                          // }
                                          return InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: Stack(
                                                children: [
                                                  SizedBox(
                                                    child: provider.followLinkData[index]
                                                                    .media !=
                                                                null &&
                                                            provider.followLinkData[
                                                                        index]
                                                                    .media!
                                                                    .length >
                                                                0
                                                      ...
                                                      : provider
                                                          ...
                                                          ? CachedNetworkImage(
                                                              imageUrl: provider
                                                                          ...
                                                                          .additional !=
                                                                      null
                                                                  ? "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].additional!}"
                                                                  : provider
                                                                              .famevideo[
                                                                                  index]
                                                                              .long !=
                                                                          null
                                                                      ? "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].long!}"
                                                                      : provider.famevideo[index].medium !=
                                                                              null
                                                                          ? "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].medium!}"
                                                                          : provider.famevideo[index].pose1 != null
                                                                              ? "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].pose1!}"
                                                                              : provider.famevideo[index].pose2 != null
                                                                                  ? "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].pose2!}"
                                                                                  : provider.famevideo[index].video != null
                                                                                      ? "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].video!}"
                                                          ...
                                                          : CachedNetworkImage(
                                                              imageUrl:
                                                                  "${ApiProvider.s3UrlPath}/${ApiProvider.famelinks}/${provider.famevideo[index].closeUp}",
                                                              placeholder: (context,
                                                                      url) =>
                                                                  CircularProgressIndicator(),
                                                              fit: BoxFit.cover,
                                ...
                                itemBuilder: (BuildContext ctx, index) {
                                  return InkWell(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              GetParticularFunLinksProfile(
                                                  id: provider.profileFunLinksList[0]
                                                      .sId,
                                                  index: index),
                                        ),
                                      );
                                    ...
                                    child: Container(
                                        ...
                                        // alignment:
                                        //     Alignment.center,
                                        child: provider.postsListOfFunLink![index]
                                                    .video ==
                                                null
                                            ? Image.network(
                                                "https://imgix.bustle.com/uploads/image/2020/8/5/23905b9c-6b8c-47fa-bc0f-434de1d7e9bf-avengers-5.jpg",
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      imageUrl:
                                                          "${ApiProvider.s3UrlPath}/${ApiProvider.funlinks}/${provider.postsListOfFunLink![index].video}",
                                                      fit: BoxFit.cover,
                                                      placeholder: (context,
                                                              url) =>
                                                          CircularProgressIndicator(),
                        ...
                        ? SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: GridView.builder(
                                ...
                                itemCount: provider.postsListOfFollowLink.length,
                                physics: NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemBuilder: (BuildContext ctx, index) {
                                  return InkWell(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                GetParticularFollowLinksProfile(
                                                    id: provider.profileFollowLinksList[
                                                            0]
                                                        .sId,
                                                    index: index),
                                          ),
