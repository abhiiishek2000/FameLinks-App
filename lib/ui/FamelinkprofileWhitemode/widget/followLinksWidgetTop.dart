...
class followLinksWidgetTopWhitemode extends StatelessWidget {
  followLinksWidgetTopWhitemode({Key? key, required this.id}) : super(key: key);
  final String id;
  @override
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              if (Constants.userType == 'brand') {
                                ...
                                fameLinkFun.getParticularUserProfileModel =
                                    null;
                                fameLinkFun
