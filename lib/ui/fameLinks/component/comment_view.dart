...
import 'package:famelink/ui/fameLinks/component/replies_view.dart';
...
class _CommentViewState extends State<CommentView> {
  ...
  Widget build(BuildContext context) {
    return Consumer<FameLinksFeedProvider>(builder: (context, provider, child) {
      return provider.feedList[provider.getIndex].media![0].type.toString() ==
              "ads"
          ? Container()
          : Form(
              key: formKey,
                          ...
                          suffixIcon: IconButton(
                              onPressed: () async {
                                if (formKey.currentState!.validate()) {
                                  ...
                                  provider
                                      .addComment(context, widget.type,
                                          widget.postId, params)
                                      .then((value) {});
                                }
                              },
