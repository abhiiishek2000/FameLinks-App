...
class ChallengeFunLinksPostScreen extends StatefulWidget {
  List<MyFunLinksResult> myFameResult;
  int index;
  int page;
  String url;

  ChallengeFunLinksPostScreen(
      this.myFameResult, this.index, this.page, this.url);

  @override
  _ChallengeFunLinksPostScreenState createState() =>
      _ChallengeFunLinksPostScreenState();
}

class _ChallengeFunLinksPostScreenState
    extends State<ChallengeFunLinksPostScreen> with TickerProviderStateMixin {
  int index = 0;
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (context, index) {
              MyFunLinksResult mediaModelData = widget.myFameResult[index];
              print("=======${widget.myFameResult[index].images![0].path}");
              Media media = Media();
              media.path = mediaModelData.video != null
                  ? mediaModelData.video
                  : mediaModelData.images![0].path;
              return Stack(
                children: [
                  SizedBox(
                    ...
                    child: Center(
                      ...
                      videoUrl:
                          "${ApiProvider.s3UrlPath}/${ApiProvider.funlinks}/${widget.myFameResult[index].images![0].path}",
                    )),
                  ),
                ],
              );
              ...
              child: Column(
                children: [
                    ...
                    child: IconButton(
                      ...
                      if (internet) {
                        ...
                        var result = await _api
                            .deleteFameLinksMedia(mediaId,widget.myFameResult[index].images[ind].type);
                        if (result != null) {
                  ...
                  IconButton(
                      ...
                      icon: Icon(
                        isMute ? Icons.volume_up_sharp : Icons.volume_off_sharp,
                        color: white,
                      ))
                ],
              ),
              ...
              children: [
                Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      likeHeart(
                          widget.myFameResult[index].likeStatus! ? null : 2,
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                            ...
                            color: widget.myFameResult[index].likeStatus!
                                ? Colors.red
                                : white),
                        Text(
                          index >= 0 &&
                                  widget.myFameResult[index].likesCount != null
                    ...
                    Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          if (index >= 0) {
                            widget.myFameResult[index].video!.isEmpty
                                ? null
                                : showFunLinkShareDialog(
                                    context,
                                    widget.myFameResult[index].sId!,
                                    widget.myFameResult[index].video!);
                          }
                        },
                      ),
                    ),
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () async {
        ...
        Api.put.call(context,
            method: "media/funlinks/${widget.myFameResult[index].sId}",
            param: map, onResponseSuccess: (Map object) {
          setState(() {
  ...
  void _myFamelinks() async {
    ...
    Api.get.call(context, method: widget.url, param: params, isLoading: false,
        onResponseSuccess: (Map object) {
      if (widget.url.contains("media/funlinks/songs/")) {
        var result = FunLinksSongPostModel.fromJson(object);
        if (result.result!.data!.length > 0) {
          setState(() {
            widget.myFameResult.addAll(result.result!.data!);
          });
  ...
  void showFunLinkShareDialog(
      BuildContext context, String postId, String data) {
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return Dialog(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          Share.share(
                            '${ApiProvider.shareUrl}post/funlinks/${postId}',
                          );
                        },
                        child: Padding(
                            padding: EdgeInsets.only(
  ...
  void _onFunLinkShare(String data) async {
    var dir = await getApplicationDocumentsDirectory();
    bool fileExists = await File("${dir.path}/${data}").exists();
    if (fileExists) {
      Constants.progressDialog(true, context);
      ...
      FFmpegKit.execute(
              "-i ${File("${dir.path}/${data}").path} -i ${_watermarkImage.path} -filter_complex overlay=W-w:H-h-75 -c:a copy ${_desFile}")
      ...
      unawaited(dio.download(
          "${ApiProvider.s3UrlPath}/${ApiProvider.funlinks}/${data}",
                      ...
                      onPressed: () async {
                        if (!commentController.text.isEmpty) {
                          ...
                          Api.post.call(context,
                              method: "media/funlinks/comment/${mediaId}",
                              param: params,
                              isLoading: false,
                              onResponseSuccess: (Map object) {
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        Api.post.call(context,
                                            method:
                                                "media/funlinks/like/comment/${comment.sId}",
                                            param: map,
                                            onResponseSuccess: (Map object) {
                                          setCommentStates(() {
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          Api.delete.call(context,
                                              method:
                                                  "media/funlinks/comment/${comment.sId}",
                                              param: {},
                                              isLoading: false,
                                              onResponseSuccess: (Map object) {
                                            setCommentStates(() {
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            Api.delete.call(context,
                                method: "media/funlinks/comment/${comment.sId}",
                                param: {},
                                isLoading: false,
                                onResponseSuccess: (Map object) {
                              setStates(() {
  ...
  void likeHeart(int? i, MyFunLinksResult data) async {
    Map<String, dynamic> map = {
      "status": i != null ? i.toString() : null,
    };
    Api.post.call(context,
        method: "media/funlinks/like/media/${mediaId}",
        param: map, onResponseSuccess: (Map object) {
      setState(() {
        if (i == null) {
          widget.myFameResult[index].likesCount =
              data.likesCount! >= 0 ? (data.likesCount)! - 1 : data.likesCount;
        } else if (i == 2) {
          widget.myFameResult[index].likesCount =
              data.likesCount! >= 0 ? (data.likesCount)! + 1 : data.likesCount;
        }
        widget.myFameResult[index].likeStatus = i == null ? false : true;
      });
    });
  }
