...
class JobLinksDial extends StatefulWidget {
  const JobLinksDial({Key? key}) : super(key: key);

  @override
  State<JobLinksDial> createState() => _JobLinksDialState();
}

class _JobLinksDialState extends State<JobLinksDial> {
  bool status1 = false;
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(
                          "assets/images/jobLinkImage.png",
                          height: 61.83,
                          width: 73,
                        ),
                        Text.rich(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: (isDarkMode == true)
                              ? AssetImage(CommonImage.dark_jobLinksMessage)
                              : AssetImage(CommonImage.light_jobLinksMessage),
                          fit: BoxFit.fill,
                        ),
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 11.0, right: 10.0, top: 0.0, bottom: 0.0),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Column(
