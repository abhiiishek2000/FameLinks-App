...
class FullFunLinksPostScreen extends StatefulWidget {
  List<MyFunLinksResult> myFameResult;
  int index;
  int page;

  FullFunLinksPostScreen(this.myFameResult, this.index, this.page);

  @override
  _FullFunLinksPostScreenState createState() => _FullFunLinksPostScreenState();
}

class _FullFunLinksPostScreenState extends State<FullFunLinksPostScreen>
              ...
              children: [
                PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    MyFunLinksResult mediaModelData =
                        widget.myFameResult[index];
                    Media media = Media();
                    media.path = mediaModelData.video;
                    return Stack(
                      children: [
                        SizedBox(
                          ...
                          child: Center(
                            child: GestureDetector(
                              ...
                              child: FeedVideoPlayer(
                                  videoUrl:
                                      "${ApiProvider.s3UrlPath}/${ApiProvider.funlinks}/${media.path!}"),
                            ),
                          ),
                        ),
                      ],
  ...
  void _myFamelinks() async {
    ...
    Api.get.call(context,
        method: "media/funlinks/${Constants.profileUserId}",
        param: params,
        isLoading: false, onResponseSuccess: (Map object) {
  ...
  void showDeletePostItemDialog() async {
    ...
    if (result != null) {
      if (result == true) {
        Api.delete.call(context, method: "media/funlinks/${mediaId}", param: {},
            onResponseSuccess: (Map object) {
          setState(() {
            isOnPageTurning = true;
          });
          widget.myFameResult.removeAt(this.index);
          Navigator.pop(context);
        });
      }
    }
