...
class _BrandProfileScreenState extends State<BrandProfileScreen>
                                  ...
                                  child: Stack(
                                    children: [
                                      upperProfileData != null &&
                                              ...
                                              upperProfileData!.brand!.bannerMedia!
                                                      .length >
                                                  0
                                                  ...
                                                  return InkWell(
                                                    onTap: () {
                                                      showFullBannerDialog(
                                                          context,
                                                          "${upperProfileData!.brand!.bannerMedia![itemIndex]}",
                                                          itemIndex);
                                                    },
                                                    child: Container(
                                                        width: MediaQuery.of(
                    ...
                    onTap: () async {
                      ...
                      if (result != null) {
                        ...
                        Api.put.call(context,
                            method:
                                "users/edit/${myFameResult.elementAt(index).sId}/brandUpload",
                          ...
                          if (result != null) {
                            ...
                            if (map['closeUp'] != null) {
                              formData.files.addAll([
                                MapEntry("media", await map['closeUp']),
                              ]);
                            }
                            if (map['medium'] != null) {
                              formData.files.addAll([
                                MapEntry("media", await map['medium']),
                              ]);
                            }
                            if (map['long'] != null) {
                              formData.files.addAll([
                                MapEntry("media", await map['long']),
                              ]);
                            }
                            if (map['pose1'] != null) {
                              formData.files.addAll([
                                MapEntry("media", await map['pose1']),
                              ]);
                            }
                            if (map['pose2'] != null) {
                              formData.files.addAll([
                                MapEntry("media", await map['pose2']),
                              ]);
                            }
                            if (map['additional'] != null) {
                              formData.files.addAll([
                                MapEntry("media", await map['additional']),
                              ]);
                            }
                            if (map['video'] != null) {
                              var snackBar = SnackBar(
                              ...
                              await MultipartFile.fromFile(info!.path!,
                                  ...
                                  .then((value) async {
                                formData.files.addAll([
                                  MapEntry("media", value),
                                ]);
                              });
                            }
                            Api.uploadPost.call(context,
                                method: "users/brand/upload", param: formData,
  ...
  _profile() async {
    Api.get.call(context, method: "users/me", param: {},
      ...
      if (upperProfileData!.brand!.bannerMedia != null &&
  ...
  void showFullBannerDialog(
      BuildContext buildContext, String bannerImg, int itemIndex) {
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return Dialog(
              ...
              backgroundColor: Colors.transparent,
              insetPadding: EdgeInsets.only(
                  top: ScreenUtil().setSp((ScreenUtil().screenHeight / 2) -
                      ScreenUtil().setSp(130)),
                  bottom: ScreenUtil().setSp((ScreenUtil().screenHeight / 2) -
                      ScreenUtil().setSp(130)),
                  left: ScreenUtil().setWidth(26),
                  right: ScreenUtil().setWidth(26)),
              child: StatefulBuilder(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            Api.delete.call(context,
                                method: "users/brand/banner/${bannerImg}",
                                isLoading: false,
                                param: {},
                                onResponseSuccess: (Map object) async {
                              setState(() {
                                upperProfileData!.agency!.bannerMedia!
                                    .removeAt(itemIndex);
                              });
                            });
                          },
                ...
                new ListTile(
                    ...
                    onTap: () async {
                      try {
                        ...
                        if (count <= 6) {
                          _cropImage(pickedFile).then((value) async {
                            print(value!.path);
                            FormData formData = FormData.fromMap({});
                            formData.files.addAll([
                              MapEntry("media",
                ...
                new ListTile(
                  ...
                  onTap: () async {
                    try {
                      ...
                      int count = 1 + upperProfileData!.brand!.bannerMedia!.length;
                      if (count <= 6) {
